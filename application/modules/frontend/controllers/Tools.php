...
class Tools extends MX_Controller {
	...
	public function viewMyTools() {
		...
		$video_storage = round($storage[0]['videos']/1024);
		$community_storage = round($storage[0]['community']/1024);
		$offer_storage = round($storage[0]['offers']/1024);
		$inquiry_storage = round($storage[0]['inquiries']/1024);
		$bstation_storage = round($storage[0]['bstation']/1024);
		$stock_storage = round($storage[0]['stockmarket']/1024);
