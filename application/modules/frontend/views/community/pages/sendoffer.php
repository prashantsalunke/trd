...
function ValidateOffer_for_you_post_in_RT_Business()
{
   ...
   if (theForm.Editbox5.value.length > 45)
   {
      alert("Please Enter The Min. Qty");
      theForm.Editbox5.focus();
      return false;
...
<div id="wb_Text140" style="position:absolute;left:89px;top:76px;width:100%;height:16px;z-index:27;text-align:left;">
...
<input type="file" id="FileUpload3" style="position:absolute;left:225px;top:191px;width:200px;height:25px;line-height:25px;z-index:20;" name="FileUpload1[]" multiple="multiple">
<textarea name="message" id="TextArea4" style="position:absolute;left:222px;top:70px;width:257px;height:84px;z-index:21;" rows="2" cols="34" maxlength="4000"></textarea>
<textarea name="title" id="TextArea3" style="position:absolute;left:222px;top:10px;width:258px;height:18px;z-index:22;" rows="5" cols="34" maxlength="4000"></textarea>
