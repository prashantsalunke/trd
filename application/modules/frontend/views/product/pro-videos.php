...
<div class="">
	<div class="col-lg-10 section11" style="padding:0px;">
		<?php if(isset($params['main_prod']) && $params['main_prod']!=''){ ?>
			<div class="col-md-12">
				<div class="row sub_products" style="width:100%;border: 1px solid rgb(211, 211, 211);background-color: rgb(255, 255, 255);max-height: 176px;height: 95px;margin-bottom:20px;">
					<div class="col-md-12">
		                    ...
		                    <?php
								...
								<div id="Layer134" class="product111"
									...
									<div id="wb_Image128" class="product6">
										<img src="<?php echo asset_url().''.$featuredProduct['main_image']; ?>" id="Image128" alt="">
									</div>
