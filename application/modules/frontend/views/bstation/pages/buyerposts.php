...
<div id="Layer3252" class="section11 spacier" onmouseenter="ShowObjectWithEffect('BLayer8_<?php echo $key;?>', 1, 'slideright', 300, 'swing');return false;" onmouseleave="ShowObject('BLayer8_<?php echo $key;?>', 0);return false;" >
	<div class="row" id="Layer4" style="background-color: #DCDCDC !important; border: 1px #C0C0C0 solid;">
		...
		<div class="col-md-3 col-sm-12" style="background-color:#fff;">
			<div id="BLayer8_<?php echo $key;?>" class="section9" onclick="ShowObjectWithEffect('BLayer5_<?php echo $key;?>', 1, 'slideright', 500, 'swing');return false;" style="visibility:hidden;background-color:#fff;">
			...
			<div id="Layer7" class="" style="height:174px;">
