...
<textarea name="message" id="TextArea1" style="position:absolute;left:222px;top:100px;width:257px;height:84px;z-index:15;" rows="2" cols="34" maxlength="4000"></textarea>
<textarea name="title" id="TextArea2" style="position:absolute;left:222px;top:34px;width:258px;height:18px;z-index:16;" rows="5" cols="34" maxlength="4000"></textarea>
