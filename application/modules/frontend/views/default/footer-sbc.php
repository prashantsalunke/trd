...
<div id="Layer99" style="position:absolute;left:0;top:100px; text-align: center; visibility: hidden; margin: 300px 0px 0px 550px; width: 332px; height: 90px; float: left; display: block; z-index: 1000000;background-color: #4B4B4B;border: 1px #A9A9A9 solid;-moz-border-radius: 2px; -webkit-border-radius: 2px; border-radius: 2px; -moz-box-shadow: 2px 2px 12px #000000;-webkit-box-shadow: 2px 2px 12px #000000;box-shadow: 2px 2px 12px #000000;">
	<div id="Layer99_Container" style="width:332px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
		...
		<div id="Layer282" style="position:absolute;text-align:left;left:100px;top:50px;width:133px;height:24px;z-index:3530;background-color: #787878;" onclick="ShowObject('Layer99', 0);return false;">
...
<div id="Layer139_Container" style="width:277px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
...
<a href="https://www.pinterest.com/join/?next=/pin/create/button/%3Furl%3Dhttp%3A//www.udtalks.com%26media%3Dhttp%3A//www.udtalks.com/images/sofa.jpg%26description%3DDescription%2520goes%2520here" target="_blank">
<div class="image_container">
<div class="front"><img alt="" src="i<?php echo asset_url();?>mages/pin.png" class="share-btns"></div>
...
<a href="" target="_blank">
<div class="image_container">
<div class="front"><img alt="" src="<?php echo asset_url();?>images/instgram.png" class="share-btns"></div>
<div class="back"><img alt="" src="<?php echo asset_url();?>images/instgram0.png" class="share-btns"></div>
</div>
</a>
</div>
...
<a href="" target="_blank">
<div class="image_container">
<div class="front"><img alt="" src="<?php echo asset_url();?>images/qq.png" class="share-btns"></div>
<div class="back"><img alt="" src="<?php echo asset_url();?>images/qq0.png" class="share-btns"></div>
</div>
</a>
</div>
</div>
