...
function saveRequest() {
	var options = {
	 		...
	 		url : '<?php echo base_url();?>b-station/savebuyerrequest',
	 		semantic : true,
	 		dataType : 'json'
	 	};
...
<div id="wb_Text140" style="position:absolute;left:89px;top:83px;width:136px;height:16px;z-index:22;text-align:left;">
...
<div id="wb_Text142" style="position:absolute;left:90px;top:105px;width:173px;height:16px;z-index:23;text-align:left;">
...
<input type="reset" id="Button2" name="" value="Cancel" style="position:absolute;left:289px;top:455px;width:96px;height:25px;z-index:6;">
