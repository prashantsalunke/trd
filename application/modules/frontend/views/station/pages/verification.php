						...
						<div id="Layer222_Container" style="width:1027px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
							...
							<div id="wb_Text760" style="position:absolute;left:565px;top:206px;width:333px;height:52px;text-align:left;">
								<span style="color:#2D2D2D;font-family:Arial;font-size:15px;">
									<?php echo $myds_stage;?>First complete your desksite then apply for verification. You have to complete adding your main products.<br>
								</span>
							</div>
							...
							<div id="wb_Text762" style="position:absolute;left:567px;top:290px;width:333px;height:28px;text-align:left;">
								<span style="color:#2D2D2D;font-family:Arial;font-size:11px;">Start with " <strong>My Desksite</strong>" icon to </span><span style="color:#808080;font-family:Arial;font-size:11px;">build </span><span style="color:#2D2D2D;font-family:Arial;font-size:11px;">your site and add your products.</span>
							</div>
						</div>
					</div>
					<?php } ?>
