	<?php $i =1; foreach($favoritedproduct as $seller) { ?>
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-1" style="padding-top: 66px;">
							<input type="checkbox" id="chkdproduct-<?php echo $i;?>" onclick="ShowObjectWithEffect('btndproductdelete-<?php echo $seller['favorite_id'];?>', 1, 'scale', 500, 'swing');return false;"
							name="chkdproduct-<?php echo $i;?>"  value="on" >
							<div id="btndproductdelete-<?php echo $seller['favorite_id'];?>" style="width: 24px; height: 24px; visibility: hidden;">
									<a href="#" onclick="delete_favorite(<?php echo $seller['favorite_id'];?>,6);"><img src="<?php echo asset_url();?>images/delete.png" id="Image160" alt=""></a>
							</div>
					</div>			
						<div class="col-md-11" >			
							...
							<div id="Layer179" style="position: absolute; text-align: left; left: 1px; top: 1px; width: 1029px; height: 174px; z-index: 1258;">
								...
								<div id="wb_Text653" style="position: absolute; left: 282px; top: 20px; width: 351px; height: 18px; z-index: 1246; text-align: left;">
									<span style="color: #303030; font-family: Georgia; font-size: 15px;"><strong><a href="./desksite.php" target="_blank" class="style5"><?php echo $seller['product_name'];?> </a></strong></span>
								</div>
							...
							<div id="SlideShow2" style="position: absolute; left: 2px; top: 2px; width: 210px; height: 173px; z-index: 1261;">
								<img class="image" style="border: solid;border-color: honeydew;" src="<?php echo asset_url();?><?php echo $seller['image'];?>" alt="" title="">
							</div>
