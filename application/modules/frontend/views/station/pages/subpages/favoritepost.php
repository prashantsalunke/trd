	<?php $i =1; foreach($favoritepost as $seller) { ?>
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-1" style="padding-top: 66px;">
							<input type="checkbox" id="chkpost-<?php echo $i;?>" onclick="ShowObjectWithEffect('btnpostdelete-<?php echo $seller['favorite_id'];?>', 1, 'scale', 500, 'swing');return false;"
							name="chkpost-<?php echo $i;?>"  value="on" >
							<div id="btnpostdelete-<?php echo $seller['favorite_id'];?>" style="width: 24px; height: 24px; visibility: hidden;">
									<a href="#" onclick="delete_favorite(<?php echo $seller['favorite_id'];?>,9);"><img src="<?php echo asset_url();?>images/delete.png" id="Image160" alt=""></a>
							</div>
					</div>			
						<div class="col-md-11" >			
							...
							<div id="Layer179" style="position: absolute; text-align: left; left: 1px; top: 1px; width: 1029px; height: 174px; z-index: 1258;">
								...
								<div id="wb_Text654" style="position: absolute; left: 235px; top: 75px; width: 548px; height: 62px; z-index: 1247; text-align: left;">
									...
									<span style="color: #4B4B4B; font-family: Arial; font-size: 12px;">PostViews :
