	<?php $i =1; foreach($favoritecatalouge as $seller) { ?>
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-1" style="padding-top: 66px;">
							<input type="checkbox" id="chkcatalouge-<?php echo $i;?>" onclick="ShowObjectWithEffect('btncatalougedelete-<?php echo $seller['favorite_id'];?>', 1, 'scale', 500, 'swing');return false;"
							name="chkcatalouge-<?php echo $i;?>"  value="on" >
							<div id="btncatalougedelete-<?php echo $seller['favorite_id'];?>" style="width: 24px; height: 24px; visibility: hidden;">
									<a href="#" onclick="delete_favorite(<?php echo $seller['favorite_id'];?>,7);"><img src="<?php echo asset_url();?>images/delete.png" id="Image160" alt=""></a>
							</div>
					</div>			
						<div class="col-md-11" >			
							...
							<div id="Layer179" style="position: absolute; text-align: left; left: 1px; top: 1px; width: 1029px; height: 174px; z-index: 1258;">
								...
								<div id="wb_Text654" style="position: absolute; left: 235px; top: 75px; width: 548px; height: 62px; z-index: 1247; text-align: left;">
									<span
										style="color: #696969; font-family: Arial; font-size: 12px;"><?php $string1 = (strlen($seller['hot_presentation']) > 13) ? substr($seller['hot_presentation'],0,250).'...' : $seller['hot_presentation']; echo $string1;?><br>
									<br>
									</span>
								</div>
						   </div>
							<div id="wb_Text656" style="position: absolute; left: 285px; top: 44px; width: 177px; height: 15px; z-index: 1259; text-align: left;">
								<span style="color: #4B4B4B; font-family: Arial; font-size: 12px;">Catalouge Title:
									<?php echo $seller['catalogue_title'];?></span><br>
							</div>
							...
							<div id="SlideShow2" style="position: absolute; left: 2px; top: 2px; width: 210px; height: 173px; z-index: 1261;">
								<img class="image" style="border: solid;border-color: honeydew;" src="<?php echo asset_url();?><?php echo $seller['catalogue_cover'];?>" alt="" title="">
							</div>
