...
<div class="panel-heading custom-panel-heading" style="text-align:left;padding-top: 5px !important;text-align:center;">
	...
	<b><input type="submit" href="" name="spitemsubmitbtn" id="spitemsubmitbtn" class="btn-custom-product btn" value="Save & Add" style="height:28px;"/></b>
...
<div class="personal_info_div" id="desk_site_step_1" style="padding:0px 10px;overflow-y:scroll;max-height:620px;">
		  		...
		  		<div class="col-sm-11" id="" style="text-align:left;">
					...
					<div style="margin-bottom:10px;">
						<span class="desk-site-text-sm">
							Add unlimited No. of products to your Desksite/Website, under your the Main or Sub <br>Products you have created.
						</span>
					</div>
				</div>
			</div>
					...
					<div class="col-sm-12">
						<div class="row">
							...
							<div class="form-group col-sm-8">
								<div class="">
									<input type="text" name="model_no" class="ds-product-input" placeholder="Model No."/>
								</div>
								<div class="messageContainer"></div>
							</div>
						</div>
				...
				<div class="row" style="margin-top:10px;">
					<div class="col-sm-12">
						<div class="row">
							...
							<div class="form-group col-sm-8">
								<div class="">
									<input type="text" name="item_name" class="ds-product-input-2x" placeholder="Product Name"/>
								</div>
								<div class="messageContainer"></div>
								<br>
						...
						<div class="row">
							...
							<div class="form-group col-sm-8">
								<div class="row">
									<div class="col-sm-4">
										<div class="">
											<input type="text" name="unit_price" class="ds-product-input-0x" placeholder="Unit Price"/>
										</div>
										<div class="messageContainer"></div>
									</div>
									...
									<div class="col-sm-4 right-align-col">
										<div class="">
											<input type="text" name="lead_time" class="ds-product-input-0x" placeholder="Production Time"/>
										</div>
										<div class="messageContainer"></div>
									</div>
						...
						<div class="row">
							...
							<div class="form-group col-sm-8">
								<div class="row">
									<div class="col-sm-4">
										<div class="">
											<input type="text" name="quantity" class="ds-product-input-0x" placeholder="Qty"/>
										</div>
										<div class="messageContainer"></div>
									</div>
									<div class="col-sm-2 right-align-col">
										<div class="">
											<input type="text" name="unit" class="ds-product-input-0-5x" placeholder="Unit"/>
										</div>
										<div class="messageContainer"></div>
									</div>
								</div>
				...
				<div class="row" style="margin-top:10px;">
					<div class="col-sm-12">
						<div class="row">
							...
							<div class="form-group col-sm-8">
								<div class="">
									<input type="text" name="cbm" class="ds-product-input-0x" placeholder="CBM"/><br>
				...
				<div class="row" style="margin-top:10px;">
					<div class="col-sm-12">
						<div class="row">
							...
							<div class="form-group col-sm-8">
								<div class="">
									<input type="text" name="brand" class="ds-product-input-0x" placeholder="Brand"/>
								</div>
								<div class="messageContainer"></div>
							</div>
						</div>
...
function saveSubProductItem() {
	...
	var options = {
			...
			url : base_url+'mystation/desksite/savenewproductitem',
			semantic : true,
			dataType : 'json'
		};
