...
<div class="row editaccount_outer">
	...
	<div class="col-md-10 account-content-area">
		<div class="tab-content main-tab-content">
			<div class="panel panel-default tab-pane fade in active" id="maintoolscreen" style="height:705px;margin-bottom:0px;">
				...
				<div class="panel-inner">
					<div id="myperformance" class="mytool-div">
						...
						<div id="wb_Text1463" style="position:absolute;left:27px;top:229px;width:202px;height:16px;z-index:3363;text-align:left;">
							<span style="color:#3C3C3C;font-family:Arial;font-size:12px;"><strong><a href="<?php echo base_url();?>desksite/<?php echo $business_stats[0]['id'];?>" target="_blank" class="style16"><?php echo base_url();?> desksite/<?php echo $business_stats[0]['id'];?></a></strong></span>
						</div>
						...
						<div id="wb_Shape15" style="padding:5px;float:left;width:55px;height:55px;margin-bottom:5px;">
							<?php if(!empty($image)) { ?>
							<img src="<?php echo asset_url();?><?php echo $image;?>" id="Shape15" alt="" style="width:50px;border-radius:4px;">
							<?php } ?>
						</div>
						<?php } ?>
						<?php } ?>
						</div>
						<div style="position:absolute;left:38px;top:50px;width:170px;height:110px;z-index:3372;color:#D3D3D3;font-family:Georgia;font-size:16px;padding-top: 25px;text-align: center;">
							<?php if(empty($product_stats[0]['products'])) { ?>
						...
						<div style="position:absolute;left:38px;top:50px;width:170px;height:110px;z-index:3387;color:#D3D3D3;font-family:Georgia;font-size:16px;padding-top: 25px;text-align: center;">
							<?php if(empty($product_stats[0]['products'])) { ?>
					...
					<div id="mystorage" style="display:none;overflow-y:scroll;max-height:630px;" class="mytool-div">
						<div class="row" style="margin:0px;">
							<div class="col-sm-7">
								<div class="text-center" style="padding-bottom:10px;"><span style="color:#2D2D2D;font-family:Arial;font-size:13px;"><strong>USAGE CHART</strong></span></div>
			...
			<div class="panel panel-default tab-pane fade in active" id="statstoolscreen" style="display:none;height:705px;margin-bottom:0px;">
				<div class="panel-heading custom-panel-heading sts-heading" style="text-align:left;padding-top: 5px !important;border-bottom: 0px;background-color:#fff !important;">
					...
					<a href="javascript:showStatProduct();" id="busi_product_sts" class="btn btn-sm btn-tool btn-tool">Products Statistics</a>
					<a href="javascript:showStatActiveProduct();" id="busi_aproduct_sts" class="btn btn-sm btn-tool btn-tool">Active Products Statistics</a>
						...
						<div class="row" style="margin:0px;">
							...
							<div class="col-sm-9">
								...
								<div class="row">
									...
									<div class="col-sm-5">
										<input type="text" id="pro_name" style="width:312px;height:19px;" name="pro_name" value="" placeholder="Type product name or no. to view statistics"/>
									</div>
									<div class="col-sm-1">
										<input type="button" id="Button18" onclick="searchProductStats();" name="Search" value="" style="width:32px;height:22px;">
									</div>
								</div>
								<br><br>
								<div>
					...
					<div id="myaproduct_stats" style="display:none;overflow-y:scroll;" class="mytoolsts-div">
						<div class="row" style="margin:0px;">
							...
							<div class="col-sm-4">
								...
								<span style="color:#2D2D2D;font-family:Arial;font-size:13px;">Active products are the most liked products by the Visitors and Buyers </span><br><br>
						...
						<div class="row" style="margin:0px;">
							...
							<div class="col-sm-9">
								<div class="row">
									...
									<div class="col-sm-5">
										<input type="text" id="apparo_name" style="width:312px;height:19px;" name="apro_name" value="" placeholder="Type product name or no. to view statistics"/>
									</div>
									<div class="col-sm-1">
										<input type="button" id="Button19" onclick="searchAproductStats();" name="Search" value="" style="width:32px;height:22px;">
									</div>
								</div>
								<br><br>
								<div>
...
function searchProductStats() {
	$.post(base_url+"mystation/product/stats",{country_name: $("#pcountry_id").val(), from_date: $("#pfrom_date").val(), to_date: $("#pto_date").val(), product_name: $("#pro_name").val(), page: 1},function(data) {
		$("#product_stats_area").html(data);
	},'html');	
}
function searchAproductStats() {
	$.post(base_url+"mystation/aproduct/stats",{country_name: $("#apcountry_id").val(), product_name: $("#apparo_name").val(), page: 1},function(data) {
...
function showNextProductStats(page) {
	$.post(base_url+"mystation/product/stats",{country_name: $("#pcountry_id").val(), from_date: $("#pfrom_date").val(), to_date: $("#pto_date").val(), product_name: $("#pro_name").val(), page: page},function(data) {
		$("#product_stats_area").html(data);
	},'html');
}
function showNextAProductStats(page) {
	$.post(base_url+"mystation/aproduct/stats",{country_name: $("#apcountry_id").val(), product_name: $("#apparo_name").val(), page: page},function(data) {
		$("#product_stats_area").html(data);
	},'html');
}
</script>
