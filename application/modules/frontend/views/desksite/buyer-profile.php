          ...
          <div id="Layer116" class="left-fixed" style="padding-top:13px; padding-left: 5px">
            ...
            <div class="container" style="margin:auto auto;">
                <div id="Layer5" class="bottomnav" style="height:105px;width:100%;margin:auto auto;">
                    <div id=" Layer5_Container " style="width:1608px;margin:auto;padding-top:40px;">
                        <div class="row" style="margin-left: 400px;">
                          
                            <div class="col-md-11 col-sm-11 bg" style="width:40%;padding-left:0px;">
                                    ...
                                    <a href="<?php echo base_url();?>buyer" class="navigation2">
            ...
            <!-- search section ends -->
            <!-- contact and add -->
            <div id="Layer49" style="position:absolute;text-align:left;visibility:hidden;left:0px;top:112px;width:25%;height:500px;z-index:3869;">
                <div id="Layer52" style="height: 373px">
                ...
                <div id="Layer58_Container" style="width:890px;text-align:left;">
                    <div id="Layer8" class="s5">
                        ...
                        <p class="box1font3" style="padding:0px;">
                            ...
                            <span style="color:#FFFFFF;font-family:Georgia;font-size:13px;"><strong> &nbsp;&nbsp;&nbsp;CURRENT REQUESTS</strong></span>
                        </p>
