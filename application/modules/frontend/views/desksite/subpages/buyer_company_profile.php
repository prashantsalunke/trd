...
foreach($Company as $company){?>
 	<div class="row">
 		...
 		<div class="col-sm-8" style="padding-top:15px;">
 			...
 			<div class="col-sm-3" style="padding-left:0px;"><img src="<?php echo asset_url().$company['profile_image']; ?>" style="width:50px;border:2px solid #f4624b;border-radius:50%;"></div>
 	...
 	<div class="row" style="padding-top:20px;">
 		<div class="col-sm-5 text-left">
 			...
 			<span style="color:#303030;font-family:Arial;font-size:12px;"><strong>Prefered Payment Method</strong></span><br/>
 			<span style="color:#303030;font-family:Arial;font-size:12px;"><strong>Annual Trade Volum</strong></span>
 		</div>
 		<div class="col-sm-7 text-left">
 			...
 			<span style="color:#808080;font-family:Arial;font-size:12px;"><?php echo $company['annual_trad_volume'];?> / Year</span>
 		</div>
