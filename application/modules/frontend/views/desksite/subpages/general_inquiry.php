...
<input type="hidden" name="busi_id" id="busi_id" value="<?php echo isset($desksite[0]['busi_id']);?>" />
<input type="hidden" name="my_busi_id" id="my_busi_id" value="<?php echo isset($mydesksite[0]['busi_id']);?>" />
...
<span style="color:#4B4B4B;font-family:Arial;font-size:16px;"><strong><?php echo $mydesksite[0]['name_prefix'];?> <?php echo $mydesksite[0]['name'];?></strong></span></div>
...
<div style="position:absolute;left:147px;top:66px;width:297px;height:38px;z-index:13;text-align:left;">
<span style="color:#3C3C3C;font-family:Arial;font-size:16px;"><strong><?php echo $mydesksite[0]['company_name'];?></strong></span></div>
</form>
</div>
</div>
